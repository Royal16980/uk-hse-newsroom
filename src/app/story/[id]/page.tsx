    ...
    <Shell>
      <article className="mx-auto max-w-3xl">
        ...
        <div className="mt-6 flex flex-wrap items-center gap-3 text-xs text-slate-600">
          ...
          {a.tags?.length ? (
            <span>• {a.tags.slice(0, 6).join(' · ')}</span>
          ) : null}
        </div>

        <div className="mt-8 rounded-2xl border border-slate-200 p-6">
          <p className="text-sm text-slate-700">
            This page is an automated index entry.
            {' '}For the full source, open:
          </p>
          <a
          ...
          <p className="mt-4 text-sm text-slate-700">
            Next: we’ll add auto-summaries, key controls, and “what to do this week” — generated by n8n and pushed into
            the feed.
          </p>
        </div>
